"""
Django settings for monalytics project.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DATABASE', default=False),
        'USER': config('POSTGRES_USER', default=False),
        'PASSWORD': config('POSTGRES_PASSWORD', default=False),
        'HOST': config('POSTGRES_HOST', default=False),
